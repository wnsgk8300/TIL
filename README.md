...
2021.07.11 - 면접 피드백 (guard문, 싱글톤 정리 )

2021.07.10 - 면접 예상질문

**객체지향**

공통된 기능들을 묶은 집합같은걸 만들고 이걸 가져다가 사용할 수 있도록 하는 프로그래밍 방식. 메모리 효율 높이고 코드 편의성

-추상화: 이름붙이는거

-캡슐화: 코드 재수정 없이 재사용 할 수 있는거

-상속: 부모클래스의 특징을 물려받아 사용하는것

-다형성: 오버라이딩 오버로딩

오버라이딩은 : 상속된걸 재정의 하는거

오버로딩은: 같은 이름 메소드 여러개를 배개변수 다르게해서 사용하는것



깃- 분산버젼관리시스템

스냅샷으로 관리해서 ;빠르고, 용량이 적다
...
델리게이트는 프로코코ㅓㄹ에서 선언한걸 구현하는것



mvvm: 뷰와 모델 의존성 없고, 뷰와 뷰모델도 의손성 없어서 각 부분이 독립적이어서 모듈화하기 쉽고



**Init 메서드가 필요한 경우와 그렇지 않은 경우의 차이점에 대해 설명**
...
2021.05.22 - Starbucks clone

2021.05.21 - 야곰의 스위프트 프로그래밍 

2021.05.20 - 앱 출시 완료

2021.05.19 - 앱 심사를 위해 제출

2021.05.16 - 게임이닭 초성퀴즈 추가

2021.05.14 - 게임이닭 디자인 마무리
